...
def process(extracted_files):
    ...
    for file_name in extracted_files:
        if file_name.endswith('.csv'):
            if 'subdivisioncodes' in file_name.lower():
                ...
                subdivision_df_main = subdivision_df_main.sort_values(['SUCountry', 'SUCode'], ignore_index=True)
    ...
    codelist_df = codelist_df.sort_values(['Country', 'Location'], ignore_index=True)
